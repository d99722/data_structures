...
public interface BinaryTree<E> {
     ...
     */
    default void preorderSubtree(Node<E> p, List<Node<E>> snapshot) {
     ...
     * @param snapshot  a list to which results are appended
     */
    default void postorderSubtree(Node<E> p, List<Node<E>> snapshot) {
        for (Node<E> c : children(p))
     ...
     */
    default void inorderSubtree(Node<E> p, List<Node<E>> snapshot) {
        if (left(p) != null)
